...
public final class Constant {
    ...
    public final static String ACTION_TOKEN_INVALID = "action_token_invalid";   //token过期广播
    public final static int NETWORK_RESPONSE_INVALIDATE = 998; //token无效
    public final static int NETWORK_RESPONSE_EXPRIED = 999; //token失效
